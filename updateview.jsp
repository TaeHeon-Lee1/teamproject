...
<body>
	<form action="memberupdate2" method="post">
		 <table border="6" align="center" width="auto">
            <caption>개인정보화면</caption>
            <tr>
            <th>아이디</th>
                <td>
                    <input type="text" name="id" id="id" value="${updateview.id}" readonly>
                </td>
            </tr>
            <tr>
             <th>닉네임☆</th>
            ...
            <tr>
             <th>이름</th>
                <td>
                    <input type="text" name="name" id="name" value="${updateview.name}" >
                </td>
            </tr>
            <tr>
              <th>생년월일</th>
            ...
            <th>이메일</th>
            	...
            	<option value="kakako.com">kakao.com</option>
            	</select>
